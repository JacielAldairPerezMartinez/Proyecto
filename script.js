...
// FIJAR LA POSICIÓN DEL MOUSE COMO INDEFINIDA CADA 5 SEGUNDOS (para evitar que el efecto se atasque en las esquinas cuando el ratón sale de la ventana) (Eso me causo muchos problemas al inicio XD) 
setInterval(function(){
	mouse.x = undefined;
	mouse.y = undefined;
}, 10);

// CREAR OBJETO PARTICULA
class Particle {
	...
	update(){
        // PILOTO AUTOMATICO CUANDO EL MOUSE DEJA EL LIENZO
...
// COMPROBACION PARA VER SI LAS PARTICULAS ESTAN CERCA COMO PARA HACER UNA LINEA ENTRE ELLAS
function connect() {
    let opacityValue = 1;
